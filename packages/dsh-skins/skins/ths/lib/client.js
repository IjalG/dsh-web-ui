window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ths_module_css_default = {
			"aionPreviewIn": "V0jYVG_aionPreviewIn",
			"thsStatusbar": "V0jYVG_thsStatusbar",
			"thsStatusbarCell": "V0jYVG_thsStatusbarCell",
			"thsStatusbarSpacer": "V0jYVG_thsStatusbarSpacer",
			"thsTitlebar": "V0jYVG_thsTitlebar",
			"thsTitlebarBtn": "V0jYVG_thsTitlebarBtn",
			"thsTitlebarIcon": "V0jYVG_thsTitlebarIcon",
			"thsTitlebarTicker": "V0jYVG_thsTitlebarTicker",
			"thsTitlebarTickerChg": "V0jYVG_thsTitlebarTickerChg",
			"thsTitlebarTickerVal": "V0jYVG_thsTitlebarTickerVal",
			"thsTitlebarTitle": "V0jYVG_thsTitlebarTitle"
		};
		//#endregion
